    ...
    <div class="container">
        <ul class="st-nav-menu nav navbar-nav">
            ...
            <li class="st-nav-section st-nav-primary nav-item">
                <a class="st-root-link nav-link" href="{{route('home')}}">صفحه اصلی</a>
                <a class="st-root-link nav-link" href="{{route('ideashow')}}">ایده‌شوها</a>
                <a class="st-root-link nav-link" href="{{route('idea')}}">ایده‌ها</a>
                    ...
                    <div class="st-popup-container">
                        ...
                        <div class="st-dropdown-content-group">
                            ...
                            <a class="regular text-warning" href="#"
                                ...
                                صفحه اصلی </a
                            >
                            <a class="regular text-primary" href="{{route('ideashow')}}"
                                ><i class="fas fa-calendar-alt ms-2"></i> ایده‌شو‌ها </a
                            ><a class="regular text-success" href="{{route('idea')}}"
