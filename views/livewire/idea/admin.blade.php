                ...
                <tbody>
                    @foreach ($ideas as $idea)
                        <tr class="intro-x">
                            ...
                            <td>
                                <a href="{{ route('idea-show', ['idea'=>$idea->id]) }}" class="font-medium whitespace-nowrap">{{$idea->title}}</a>
                                <div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">{{$idea->created_at->diffForHumans();}}</div>
                            </td>
                            <td class="text-center">{{ $idea->sumRating}}</td>
                                ...
                                <div class="flex justify-center items-center">
                                    ...
                                    @else
                                        ...
                                        <a
                                            ...
                                            role="button"
                                            wire:click.prevent="setDeleteID({{ $idea->id }})"
