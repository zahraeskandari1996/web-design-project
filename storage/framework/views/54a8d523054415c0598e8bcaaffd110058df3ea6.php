<div class="flex justify-center">
    <?php $__env->startSection('breadcrumb'); ?>
        <div class="-intro-x breadcrumb ml-auto hidden sm:flex">
            ...
            ></i>
            <a href="<?php echo e(route('idea')); ?>" > ایده‌ها</a>
            <i
                data-feather="chevron-left"
                class="breadcrumb__icon"
            ></i>
            <a href="" class="breadcrumb--active"> <?php echo e($idea->title); ?></a>
        </div>
    ...
    <div class="intro-y mt-4 w-full lg:w-2/3 news">
        ...
        <div class="intro-y box mt-4">
            ...
            >
                ...
                <a
                role="button"
                href="<?php echo e(route('ideashow-show', ['ideashow' => $idea->ideashow->id])); ?>"
            ...
            >
                ...
                >
                    <?php echo e($idea->ideashow->title); ?>
            ...
            <div class="p-5">
                <div class="preview flex flex-col sm:flex-row">
                    <div>
                        <div class="flex items-center flex-col justify-between">
                               <span wire:click.prevent="upVote" class="cursor-pointer <?php echo e($idea->userSumRating == 1 ? "disabled" : ""); ?>">
                            <svg width="36" height="36" style="transform: rotate(180deg);">
                                <path d="M2 10h32L18 26 2 10z" fill="<?php echo e($idea->userSumRating == 1 ? "#F59E0B" : "#c7d2fe"); ?>"></path>
                            </svg>
                        </span>
                            <span style="line-height: normal; direction: ltr;" class="p-1 text-xl font-semibold text-center"><?php echo e($idea->sumRating ?? 0); ?></span>
                            <span wire:click.prevent="downVote" class="cursor-pointer <?php echo e($idea->userSumRating == -1 ? "disabled" : ""); ?>">
                ...
                <div class="intro-y flex relative mt-5 items-center pt-6 border-t border-gray-200">
                    <div class="flex items-center">
                        <div class="w-12 h-12 flex-none image-fit">
                            <img
                                alt="<?php echo e($idea->user->username); ?>"
                                class="rounded-full"
                ...
                <div class="intro-y mt-5 pt-5 border-t border-gray-200 dark:border-dark-5">
                    <div class="text-base sm:text-lg font-medium"><?php echo e($idea->comments->count()); ?> پاسخ</div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-5 pt-5 border-t border-gray-200 dark:border-dark-5">
                        <div class="flex">
                            <div class="w-10 h-10 sm:w-12 sm:h-12 flex-none image-fit">
                                <img alt="<?php echo e($User::find($comment->user_id)->email); ?>" class="rounded-full" src="<?php echo e(Storage::url($User::find($comment->user_id)->profile_photo_path)); ?>">
                            </div>
                            <div class="mr-3 flex-1">
                                <div class="flex items-center"> <a href="" class="font-medium"><?php echo e($User::find($comment->user_id)->name); ?></a> <a href="" class="mr-auto text-xs text-gray-600"><?php echo e($comment->created_at->diffForHumans()); ?></a> </div>
                                <div class="text-gray-600 text-xs sm:text-sm"><?php echo e($User::find($comment->user_id)->email); ?></div>
                                <div class="mt-2"><?php echo e($comment->comment); ?></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex items-center justify-center mt-5 w-full">
                    <?php echo e($comments->links('paginate')); ?>
...
<?php /**PATH C:\Users\M0B\Desktop\Projects\idea-show\resources\views/livewire/idea/show.blade.php ENDPATH**/ ?>