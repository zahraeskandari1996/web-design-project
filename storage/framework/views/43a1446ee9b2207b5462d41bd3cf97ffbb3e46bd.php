...
} elseif ($_instance->childHasBeenRendered('l4106532416-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4106532416-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4106532416-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4106532416-0');
} else {
    $response = \Livewire\Livewire::mount('landing.layout.header');
    $html = $response->html();
    $_instance->logRenderedChild('l4106532416-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            ...
            <div class="row text-center">
                <div class="col-12 col-lg-6 mx-auto">
                    ...
                    <nav class="nav d-flex justify-content-center mb-5 mt-7">
                        <a
                            href="<?php echo e(route('ideashow')); ?>"
        ...
        <div class="container" id="aboutus">
            <div class="row align-items-centerpb-5">
                ...
                <div class="col-md-6 text-end">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-rounded btn-primary"
                        > ثبت نام</a
                    >
                </div>
            </div>
...
} elseif ($_instance->childHasBeenRendered('l4106532416-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l4106532416-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4106532416-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4106532416-1');
} else {
    $response = \Livewire\Livewire::mount('landing.layout.footer');
    $html = $response->html();
    $_instance->logRenderedChild('l4106532416-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

<?php /**PATH C:\Users\M0B\Desktop\Projects\idea-show\resources\views/livewire/landing/home.blade.php ENDPATH**/ ?>