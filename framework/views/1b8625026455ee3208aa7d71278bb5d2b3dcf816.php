...
} elseif ($_instance->childHasBeenRendered('yy6H90f')) {
    $componentId = $_instance->getRenderedChildComponentId('yy6H90f');
    $componentTag = $_instance->getRenderedChildComponentTagName('yy6H90f');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yy6H90f');
} else {
    $response = \Livewire\Livewire::mount('landing.login');
    $html = $response->html();
    $_instance->logRenderedChild('yy6H90f', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
...
</html><?php /**PATH C:\Users\M0B\Desktop\Projects\idea-show\resources\views/welcome.blade.php ENDPATH**/ ?>